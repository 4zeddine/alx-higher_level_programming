...
class TestSquare_y(unittest.TestCase):
    """Unittests that tests initialization of Square y attribute."""
...
class TestSquare_order_of_initialization(unittest.TestCase):
    """Unittests that tests order of Square attribute initialization."""
...
class TestSquare_area(unittest.TestCase):
    """Unittests that tests the area method of the Square class."""
...
class TestSquare_stdout(unittest.TestCase):
    """Unittests that tests __str__ and display methods of Square class."""
...
class TestSquare_update_args(unittest.TestCase):
    """Unittests that tests update args method of the Square class."""
