...
Project done during **Full Stack Software Engineering studies** at **ALX Program**. It aims to learn about if/else statements, loops, range and functions in **Python**.
