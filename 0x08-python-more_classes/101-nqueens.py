#!/usr/bin/python3
"""Aims at solving the N-queens puzzle.

Determines all the possible solutions for placing N
...
def xout(board, row, col):
    """put X on spots of the chessboard.
...
def recursive_solve(board, row, queens, solutions):
    """recursively solving the N-queens puzzle.
